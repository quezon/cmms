const ptBRJSON = {
    ...
    'work-requests.checks.1': 'Reduza o tempo gasto no tratamento de solicitações de trabalho em até 34%.',
    'work-requests.checks.2': 'Reduza o tempo de comunicação com os solicitantes em até 41% (chamadas, e-mails, textos).',
  
    'mobile-app.title': 'Um aplicativo CMMS móvel que capacita sua equipe de manutenção',
    ...
    'mobile-app.descriptions.1': 'A partir de seu dispositivo móvel, qualquer membro da equipe de manutenção pode:',
    ...
    'mobile-app.checks.5': 'Consultar informações críticas do ativo ao diagnosticar um problema.',
    ...
    'eam.checks.0': 'Conheça a saúde de seus ativos a qualquer momento e quanto eles estão custando',
    'eam.checks.1': 'Visualize registros de manutenção completos e detalhados.',
    'eam.checks.2': 'Rastreie apenas o que você deseja com campos personalizados ilimitados',
    ...
    'pm.checks.1': 'Notificações automáticas por push e e-mail quando uma PM é criada ou vencida.',
    'pm.checks.2':
    ...
    'pm.checks.4': 'Após a conclusão da PM, o trabalho é automaticamente registrado no registro de manutenção do ativo.',
    ...
    'part.checks.3': 'Conheça o uso da peça. Visualize o registro de peças para ver onde a peça está sendo usada e por quem',
    ...
    leading_maintenance: 'Liderando o caminho para um futuro melhor para manutenção e confiabilidade',
    //register
    ...
    report: 'Relatório',
    end_cannot_be_ulterior_to_start: 'A data de término não pode ser posterior à data de início',
    ...
    camera: 'Câmera',
    CANCELLED: 'Rejeitado',
    max_file_size_error: 'O tamanho do arquivo não deve ser maior que {{size}} MB',
