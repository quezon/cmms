...
Rename to `.env` and configure the environment variables in this file [.env.example](.env.example)
...
### Run
Download this [docker-compose.yml file](./docker-compose.yml) and run 
...
### Mobile app
You can use the [live Android app](https://play.google.com/store/apps/details?id=com.atlas.cmms) and configure it with your custom server url
## Getting help
