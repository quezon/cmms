...
| LOGO_PATH                   | No       | Custom logo path. Needs a license                                                                                                                                                                                                                                                                     | (empty)               |
| CUSTOM_COLORS               | No       | Custom colors in JSON format. All colors should be in hexadecimal format. `{"emailColors": "#00A0E3",primary: '#5569ff',  secondary: '#6E759F',  success: '#57CA22',  warning: '#FFA319',  error: '#FF1943',  info: '#33C2FF',  black: '#223354',  white: '#ffffff',  primaryAlt: '#000C57'}`         | (empty)               |
