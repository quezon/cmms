...
If you are using a remote server, make sure to open `REACT_APP_API_URL`, `PUBLIC_FRONT_URL` ports numbers by default
8080, and 3000. Same for `MINIO_PUBLIC_ENDPOINT` port 9000 if you use Minio.
